...
// opened by mcpClientSheet's OAuth2Authorizer expects a postMessage on its
// opener window; this page sends it and closes itself.
//
// If there's no opener (user opened the URL directly), fall back to
...
export default function MCPSessionsOAuthCallbackPage() {
			...
			<div className="w-full rounded-lg border bg-card p-8 text-center shadow-sm">
				...
				<div className="mt-6">
					<Button asChild variant="outline" data-testid="mcp-callback-back-button">
						<Link to="/workspace/mcp-sessions">Back to MCP sessions</Link>
					</Button>
				</div>
			</div>
		</div>
